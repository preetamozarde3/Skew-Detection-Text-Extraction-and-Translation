...
# # using terract to identfiy text in hindi from image
# # text = pytesseract.image_to_string(Image.open('./images/pic_12.png'), lang='hin')
# # print(text)
# # # filename='D:\Praja_dummy_2\marathi_text.txt'
# # # with open(filename, "w", encoding="utf-8") as f:
# # #     f.write(text)

# imagesPath='./images_preetam/'

# image_list = os.listdir(imagesPath)
# image_list.sort()
# print(image_list)

# filename='D:\Praja_dummy_2\hindi_pdf_text_preetam.txt'
# translated_filename='D:\Praja_dummy_2\eng_translated_pdf_text_preetam.txt'
# translator = Translator()
# with open(translated_filename, "w", encoding="utf-8") as f2:
#     with open(filename, "w", encoding="utf-8") as f:
#         for each_image in image_list:
#             each_image_path = os.path.join(imagesPath, each_image)
#             # print(each_image_path)
#             print("Current image is: ",each_image)
#             # f.write(each_image)
#             text = pytesseract.image_to_string(Image.open(each_image_path), lang='mar')
#             print("Text in image is: \n",text,'\n\n')
#             f.write(text)
#             text = translator.translate(text).text
#             text.replace('\\n', " ") 
#             f2.write(translator.translate(text).text)
#             f2.write('\n\n')
#             f.write('\n\n')
#     f.close()
